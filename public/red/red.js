...
var RED = (function () {
    ...
    function loadEditor() {
        ...
        */
        ...
        RED.log_display_fe.init();
        RED.log_ws_fe.init();
        RED.result_ws_fe.init();
        RED.startup.init();
    ...
    function createExportableNodeSet(set) {
        ...
        for (var n=0;n<set.length;n++) {
            ...
            if (node.type.substring(0,8) == "subflow:") {
                var subtaskId = node.type.substring(8);
                if (!exportedSubflows[subtaskId]) {
                    exportedSubflows[subtaskId] = true;
                    var subflow = getSubflow(subtaskId);
                ...
                itemStyle: {
                    normal: {
                        color: {
                            ...
                            r: 1,
                            colorStops: [{
                                offset: 0, color: 'rgb(169, 169, 169)' // 0% 处的颜色
                            }, {
                                offset: 1, color: 'rgba(169, 169, 169, 0.1)' // 100% 处的颜色
                            }],
