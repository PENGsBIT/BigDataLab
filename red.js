...
//settings.uiPort = parsedArgs.port||settings.uiPort||1888;
...
/*
* I add these codes to enable server proxy to solve the problem of crossing origin.
* */
var proxyRouter = require('./proxy/proxy');
var flowRouter = require('./proxy/getFLow');
app.use('/myproxy', proxyRouter);
app.use('/myproxy', flowRouter);
